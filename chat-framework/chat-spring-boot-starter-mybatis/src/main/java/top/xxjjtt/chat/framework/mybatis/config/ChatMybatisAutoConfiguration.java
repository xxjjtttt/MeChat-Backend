package top.xxjjtt.chat.framework.mybatis.config;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.StrUtil;
import top.xxjjtt.chat.framework.common.util.json.JsonUtils;
import top.xxjjtt.chat.framework.mybatis.core.handler.DefaultDBFieldHandler;
...
@MapperScan(value = "${chat.info.base-package}", annotationClass = Mapper.class,
        lazyInitialization = "${mybatis.lazy-initialization:false}") // Mapper 懒加载，目前仅用于单元测试
public class ChatMybatisAutoConfiguration {
