 ...
 *      1）Spring Async：
 *          {@link top.xxjjtt.chat.framework.quartz.config.ChatAsyncAutoConfiguration#threadPoolTaskExecutorBeanPostProcessor()}
 *      2）Spring Security：
 *          TransmittableThreadLocalSecurityContextHolderStrategy
 *          和 ChatSecurityAutoConfiguration#securityContextHolderMethodInvokingFactoryBean() 方法
 *
 */
package top.xxjjtt.chat.framework.tenant;
