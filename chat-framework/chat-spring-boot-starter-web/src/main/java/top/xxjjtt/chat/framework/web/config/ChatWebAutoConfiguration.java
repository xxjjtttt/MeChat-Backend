package top.xxjjtt.chat.framework.web.config;
...
import top.xxjjtt.chat.framework.web.core.filter.CacheRequestBodyFilter;
import top.xxjjtt.chat.framework.web.core.filter.DemoFilter;
import top.xxjjtt.chat.framework.web.core.handler.GlobalExceptionHandler;
import top.xxjjtt.chat.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class ChatWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "chat.demo", havingValue = "true")
