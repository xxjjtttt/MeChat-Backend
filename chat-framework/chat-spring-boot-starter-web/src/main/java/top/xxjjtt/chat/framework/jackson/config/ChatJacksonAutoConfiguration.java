package top.xxjjtt.chat.framework.jackson.config;

import top.xxjjtt.chat.framework.common.util.json.JsonUtils;
import top.xxjjtt.chat.framework.common.util.json.databind.NumberSerializer;
import top.xxjjtt.chat.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import top.xxjjtt.chat.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class ChatJacksonAutoConfiguration {
