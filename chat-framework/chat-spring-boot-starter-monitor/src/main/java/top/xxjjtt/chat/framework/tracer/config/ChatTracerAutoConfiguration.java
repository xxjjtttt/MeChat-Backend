package top.xxjjtt.chat.framework.tracer.config;

import top.xxjjtt.chat.framework.common.enums.WebFilterOrderEnum;
import top.xxjjtt.chat.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "chat.tracer", value = "enable", matchIfMissing = true)
public class ChatTracerAutoConfiguration {
