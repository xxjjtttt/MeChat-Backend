...
import top.xxjjtt.chat.framework.common.enums.DocumentEnum;
import top.xxjjtt.chat.framework.mq.redis.core.RedisMQTemplate;
import top.xxjjtt.chat.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import top.xxjjtt.chat.framework.mq.redis.core.job.RedisStreamMessageCleanupJob;
import top.xxjjtt.chat.framework.mq.redis.core.pubsub.AbstractRedisChannelMessageListener;
import top.xxjjtt.chat.framework.mq.redis.core.stream.AbstractRedisStreamMessageListener;
...
public class ChatRedisMQConsumerAutoConfiguration {
