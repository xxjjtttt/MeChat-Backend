package top.xxjjtt.chat.module.system.controller.admin.socail.vo.client;
...
import top.xxjjtt.chat.framework.common.validation.InEnum;
...
public class SocialClientSaveReqVO {
    ...
    @Schema(description = "应用名", requiredMode = Schema.RequiredMode.REQUIRED, example = "chat商城")
