package top.xxjjtt.chat.module.system.service.social;
...
import top.xxjjtt.chat.framework.common.enums.UserTypeEnum;
import top.xxjjtt.chat.framework.common.pojo.PageResult;
import top.xxjjtt.chat.framework.common.util.cache.CacheUtils;
import top.xxjjtt.chat.framework.common.util.http.HttpUtils;
import top.xxjjtt.chat.framework.common.util.object.BeanUtils;
import top.xxjjtt.chat.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import top.xxjjtt.chat.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import top.xxjjtt.chat.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import top.xxjjtt.chat.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import top.xxjjtt.chat.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import top.xxjjtt.chat.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import top.xxjjtt.chat.module.system.dal.dataobject.social.SocialClientDO;
import top.xxjjtt.chat.module.system.dal.mysql.social.SocialClientMapper;
import top.xxjjtt.chat.module.system.dal.redis.RedisKeyConstants;
import top.xxjjtt.chat.module.system.enums.social.SocialTypeEnum;
import top.xxjjtt.chat.module.system.framework.justauth.core.AuthRequestFactory;
...
import static top.xxjjtt.chat.framework.common.util.collection.MapUtils.findAndThen;
import static top.xxjjtt.chat.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static top.xxjjtt.chat.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
import static top.xxjjtt.chat.framework.common.util.json.JsonUtils.toJsonString;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${chat.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${chat.wxa-subscribe-message.miniprogram-state:formal}")
