package top.xxjjtt.chat.module.system.framework.captcha.config;

import top.xxjjtt.chat.module.system.framework.captcha.core.RedisCaptchaServiceImpl;
...
public class ChatCaptchaConfiguration {
