...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "top.xxjjtt.chat";
    private static final String ARTIFACT_ID = "chat";
    private static final String PACKAGE_NAME = "top.xxjjtt.chat";
    private static final String TITLE = "MeChat";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "top.xxjjtt.chat";
        String artifactIdNew = "chat";
        String packageNameNew = "top.xxjjtt.chat";
        String titleNew = "MeChat";
        String projectBaseDirNew = "C:\\Users\\Administrator\\Desktop\\MeChat-Backend"; // 一键改名后，“新”项目所在的目录
